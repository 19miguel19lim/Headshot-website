...
function Nathan() {
  return (
    <div className="max-w-md mx-auto px-4 md:max-w-xl lg:max-w-7xl overflow-hidden">
      <div className="flex flex-col justify-center  overflow-hidden items-center mb-32 pt-16 pb-[2rem] space-y-8  bg-black text-white bg-BgX bg-contain  bg-no-repeat rounded-xl lg:flex-row lg:space-y-0 lg:space-x-24 lg:items-start lg:pl-10  lg:pb-[5rem] lg:w-full lg:bg-cover">
        <img
          src="assets/Nathan-logo.png"
          alt=""
          className="lg:scale-150 lg:pt-16"
        />
        <div className="flex flex-col space-y-8 items-center lg:items-start">
          <div className="flex flex-col space-y-8 items-center lg:flex-row lg:space-y-0 lg:space-x-12">
            <h1 className="text-4xl font-black uppercase text-center md:text-5xl lg:text-4xl lg:max-w-xl lg:text-left max-w-xs">
              nathan reimche-vu{" "}
            </h1>
          ...
          <p className="max-w-xs text-gray-500 tracking-widest text-lg text-center lg:max-w-4xl lg:text-left">
            {content}
          </p>
